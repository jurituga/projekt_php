...
return [
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'com.vacanto.desktop'),
     ...
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'Vacanto — jobs and freelance services platform'),

    /**
     * The Website of your application.
     */
    'website' => env('NATIVEPHP_APP_WEBSITE', 'https://vacanto.local'),
